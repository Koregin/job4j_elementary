...
public class CinemaTest {
    ...
    @Test
    public void checkEmptyPlace2() {
        Place[][] places = {
                {new Place(0, 0), null, null},
                {null, new Place(1, 1), null},
                {new Place(2, 0), new Place(2, 1), new Place(2, 2)}
        };
        Place rsl = Cinema.checkEmptyPlace(places);
    ...
    @Test
    public void checkEmptyPlace3() {
        Place[][] places = {
                {new Place(0, 0), null, new Place(0, 2)},
                {null, new Place(1, 1), null},
                {new Place(2, 0), null, null}
        };
        Place rsl = Cinema.checkEmptyPlace(places);
    ...
    @Test
    public void checkEmptyPlace4() {
        Place[][] places = {
                {new Place(0, 0), null, new Place(0, 2)},
                {null, new Place(1, 1), null},
                {null, null, new Place(2, 2)}
        };
        Place rsl = Cinema.checkEmptyPlace(places);
        Place expected = new Place(2, 0);
        assertThat(rsl, is(expected));
    }

    @Test
    public void checkEmptyPlace5() {
        Place[][] places = {
                {null, null, null},
                {new Place(1, 0), null, new Place(1, 2)},
                {null, null, new Place(2, 2)}
        };
        Place rsl = Cinema.checkEmptyPlace(places);
        Place expected = new Place(0, 1);
        assertThat(rsl, is(expected));
    }
